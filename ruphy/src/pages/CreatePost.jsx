    ...
    <section className='max-w-5xl mx-auto'>
        <div>
            ...
            <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>
                ...
                through Ruphy AI and share them with the Community
            </p>
        </div>
        <form className='mt-6 max-w-3xl' onSubmit={handleSubmit}>
          ...
          <FormField 
           ...
           <div className='mt-10'>
            <p className='mt-2 text-sm text-[14px] text-[#666e75]'>
                Once you have generated the image you like, you can share it with the Community
            </p>
            <div className='mt-3'>
                <button 
                type='button'
